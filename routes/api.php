...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get("/student/getAllResults/{id}",[ResultController::class,'getAllResultsClassroom']);
    ...
    Route::get("/student/examsClassroom/{id}", [ExamController::class, "getExamsClassroomStudent"]);
});
